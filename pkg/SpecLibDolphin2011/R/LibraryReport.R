...
\"A non-targeted GCxGC/TOF-MS method and software for inventorying persistent and bioaccumulative contaminants in marine 
environments\", Environmental Science and Technology, in press.",
              y = 0.7, gp = gpar(cex = 1))
